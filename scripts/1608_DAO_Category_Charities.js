...
const opt = {
  ...
  name: DATA.daoCategories.Charities.name,
  amount: DATA.daoCategories.Charities.amount,
  tge: DATA.daoCategories.Charities.tge,
  cliffTime: DATA.daoCategories.Charities.cliffTime,
  afterCliffUnlockPerThousand: DATA.daoCategories.Charities.afterCliffUnlockPerThousand,
  unlockPeriods: DATA.daoCategories.Charities.unlockPeriods,
  unlockPerThousand: DATA.daoCategories.Charities.unlockPerThousand,
}
