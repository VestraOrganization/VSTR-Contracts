...
const opt = {
  ...
  name: DATA.daoCategories.GameFi.name,
  amount: DATA.daoCategories.GameFi.amount,
  tge: DATA.daoCategories.GameFi.tge,
  cliffTime: DATA.daoCategories.GameFi.cliffTime,
  afterCliffUnlockPerThousand: DATA.daoCategories.GameFi.afterCliffUnlockPerThousand,
  unlockPeriods: DATA.daoCategories.GameFi.unlockPeriods,
  unlockPerThousand: DATA.daoCategories.GameFi.unlockPerThousand,
}
